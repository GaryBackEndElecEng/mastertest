...
const directGraph = `${masterImage}/directGraph3.png`;
 ...
 export const allNavLinks: navImageLinkType[] = [
   ...
   {id:4,icon:<ExploreIcon sx={{color:"red",ml:1,mr:1,fontSize:"130%"}}/>, name: "miscgraph", image: graph ,link:"/extra/countrygraph",desc:[{para:" This allows you to view world's and continent's populations."},{para:" It provides a visual snap-shot of population density."}],},
   {id:5,icon:<SportsEsportsIcon sx={{color:"red",ml:1,mr:1,fontSize:"130%"}}/>, name: "rawio", image: rawio ,link:"/games/rawio",desc:[{para:" This displays all video games. It allows the viewer to take an inside look of the game. In addition, it has store links for quick purchases"}]},
     ...
     {id:11,icon:<InfoIcon sx={{color:"red",ml:1,mr:1,fontSize:"130%"}}/>, name: "countries", image: countries ,link:"/ultils/countries",desc:[{para:"This provides all world country's general information from populations to telephone prefixes."}] },
