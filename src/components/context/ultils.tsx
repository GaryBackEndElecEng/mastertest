...
import type {userType,DataType,userAccountType,PostDataType,testPosts, userInfoType} from "@component/context/type";
...
export async function getAllusers():Promise<userType[] | null>{
  "use server"
  const users: userType[] | null= await prisma.user.findMany({
    include:{
      posts:true,
      answers:true
    }
