...
const GetClient_DNSlookup = () => {
  ...
  return (
    <div className="flex flex-col justify-center items-center my-2 w-full shadow-lg shadow-blue rounded-lg p-2">
      ...
      <FormControl className="bg-white text-black rounded-lg shadow-lg shadow-blue flex flex-col gap-2 text-center">
        ...
        />
        {!msg ?
        <FormHelperText className="text-lg text-center bg-white text-black p-1 px-2" >example.com</FormHelperText>
        :
        <FormHelperText className="text-lg text-center bg-black text-white  p-1 px-2">{msg}</FormHelperText>
        }
      </FormControl>
      <div className="flex flex-col justify-center items-center ">
          <button className="text-center text-md p-2 px-4 rounded-lg border border-black shadow-lg shadow-blue hover:bg-blue hover:tracking-wide hover:shadow-xl" onClick={(e) => handleDNS(e)}>Submit</button>
          {dns && <button className="text-center mt-2 text-md p-2 px-4 rounded-lg border border-black shadow-lg shadow-blue hover:bg-blue hover:tracking-wide hover:shadow-xl" onClick={() => handleReset()}>reset</button>}
      </div>
      </div>
