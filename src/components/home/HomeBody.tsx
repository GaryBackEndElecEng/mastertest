...
const HomeBody = () => {
  ...
  const imageDecorate: string = "aspect-video rounded-[50%] static top-[15%] left-[20%] h-[auto] shadow-lg shadow-blue p-1";
  const imageDecorate2: string = "aspect-video rounded-[30%] static top-[15%] left-[20%] h-[auto] shadow-lg shadow-blue p-1";
  const gridSpans: string = "card grid-spans-1/3 h-[400px] w-[400px] border-4 border-indigo-500 grid place-items-center bg-indigo-500 relative bg-site_blue_dark ";
